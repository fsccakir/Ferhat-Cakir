...
<!-- ============================== NOTLAR ================================= -->
<!-- ======================================================================= -->
[^1]: Ferhat Sertaç Çakır, [Github Repo](https://github.com/fsccakir/Ferhat-Cakir.git)
...
library(tidyverse)
library(here)
survey <- read_csv("https://raw.githubusercontent.com/fsccakir/Ferhat-Cakir/main/survey.csv")
...
```{r, echo=FALSE}
library(xtable) 
# devtools::install_github("fsccakir/Ferhat-Cakir")
...
cy <- readr::read_csv("https://raw.githubusercontent.com/fsccakir/Ferhat-Cakir/main/survey.csv")
